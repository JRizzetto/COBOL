      ...
      ******************************************************************
       ...
       PROCEDURE DIVISION.
      ******************************************************************
      *    INICIALIZA AS VARIÁVEIS E CHAMA OS DEMAIS PARAGRAFOS
      * ****************************************************************
       P100-INICIAL.
       ...
       P100-INICIAL-FIM.
      ******************************************************************
      *    VERIFICA O MES DA DATA DIGITADA PELO USUARIO
      * ****************************************************************
       P200-VER-MES.
            DISPLAY "VERIFICANDO DO MES DA DATA INFORMADA..."
       ...
       P200-VER-MES-FIM.
      ******************************************************************
      *    MOSTRA O RESULTADO COM OPCAO DE REPOCESSAMENTO
      * ****************************************************************
       P300-MOSTRA.
